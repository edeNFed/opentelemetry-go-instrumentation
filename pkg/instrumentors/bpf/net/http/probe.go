...
//}
//
//func New() *httpInstrumentor {
//	return &httpInstrumentor{}
//}
//
//func (h *httpInstrumentor) LibraryName() string {
//	return "net/http"
//}
//
//func (h *httpInstrumentor) FuncNames() []string {
//	return []string{"net/http.(*Client).Do"}
//}
//
//func (h *httpInstrumentor) Load(ctx *context.InstrumentorContext) error {
...
//}
//
//func (h *httpInstrumentor) Run(eventsChan chan<- *events.Event) {
...
//}
//
//func (h *httpInstrumentor) convertEvent(e *HttpEvent) *events.Event {
